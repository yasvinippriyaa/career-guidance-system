...
<div class="card">
  <div class="container">
  <center><p>Do you enjoy lawsuits and love to argue and persuade?</p></center>
<div class="option-group">
  <div class="option-container">

    <input class="option-input" id="option-1" type="radio" name="q7" value="yes"/>
    <input class="option-input" id="option-2" type="radio" name="q7" value="no"/>
...
if(isset($_POST['submit'])){
    ...
    if($ans=="no"){
        ...
        $sql = "SELECT yes FROM quiz WHERE question=7";
        $result = mysqli_query($conn,$sql);
        $row = mysqli_fetch_array($result);
        $loc = $row['yes'];
        $_SESSION['result'] = 'lawyer';
    }
